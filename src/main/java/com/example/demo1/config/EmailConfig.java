...
public class EmailConfig {
    ...
    public JavaMailSender mailSender() {//JAVA MAILSENDER 인터페이스를 구현한 객체를 빈으로 등록하기 위함.
        ...
        mailSender.setPort(587);// 587로 포트를 지정(SMTP)
        mailSender.setUsername("xmrrhdwjdqls@gmail.com");//구글계정을 넣습니다.
        mailSender.setPassword("fayg mhxt sfox rtil");//구글 앱 비밀번호를 넣습니다.
        ...
        mailSender.setJavaMailProperties(javaMailProperties);//mailSender에 만든 properties 넣고
